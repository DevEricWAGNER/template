      ...
      >
        ...
        >
          ...
          <form method="POST" action="{{ route('logout') }}">
            @csrf
            <a href="{{ route('logout') }}" class="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base" onclick="event.preventDefault(); this.closest('form').submit();">
                <svg
                  class="fill-current"
                  width="22"
                  height="22"
