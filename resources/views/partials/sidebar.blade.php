    ...
    <div>
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            ...
            @else
                <a
                class="group relative cursor-not-allowed flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark-1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                @if (request()->routeIs('project.*'))
                    :class="'bg-graydark dark:bg-meta-4'"
                @endif
                 disabled>
