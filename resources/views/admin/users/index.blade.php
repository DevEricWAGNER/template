                ...
                <div class="relative overflow-hidden">
                   ...
                   <div class="overflow-x-auto">
                      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                         <thead class="text-xs uppercase text-boxdark bg-gray-50 dark:bg-boxdark dark:text-gray-400">
                            <tr>
                            ...
                            @foreach ($users as $user)
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-boxdark">
                                    ...
                                    <div class="flex items-center">
                                        <input id="checkbox-table-search-1" type="checkbox" onclick="event.stopPropagation()" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-personnalise-600 focus:ring-personnalise-500 dark:focus:ring-personnalise-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-boxdark dark:border-gray-600">
                   ...
                   <nav class="flex flex-col items-start justify-between p-4 space-y-3 md:flex-row md:items-center md:space-y-0" aria-label="Table navigation">
                      ...
                      <ul class="inline-flex items-stretch -space-x-px">
                         <li>
                            <a href="#" class="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-boxdark dark:bg-boxdark dark:border-boxdark dark:text-gray-400 dark:hover:bg-boxdark dark:hover:text-white">
                         ...
                         <li>
                            <a href="#" class="flex items-center justify-center px-3 py-2 text-sm leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-boxdark dark:bg-boxdark dark:border-boxdark dark:text-gray-400 dark:hover:bg-boxdark dark:hover:text-white">1</a>
                         </li>
                         <li>
                            <a href="#" class="flex items-center justify-center px-3 py-2 text-sm leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-boxdark dark:bg-boxdark dark:border-boxdark dark:text-gray-400 dark:hover:bg-boxdark dark:hover:text-white">2</a>
                         </li>
                         <li>
                            <a href="#" aria-current="page" class="z-10 flex items-center justify-center px-3 py-2 text-sm leading-tight border text-personnalise-600 bg-personnalise-50 border-personnalise-300 hover:bg-personnalise-100 hover:text-personnalise-700 dark:border-boxdark dark:bg-boxdark dark:text-white">3</a>
                         </li>
                         <li>
                            <a href="#" class="flex items-center justify-center px-3 py-2 text-sm leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-boxdark dark:bg-boxdark dark:border-boxdark dark:text-gray-400 dark:hover:bg-boxdark dark:hover:text-white">...</a>
                         </li>
                         <li>
                            <a href="#" class="flex items-center justify-center px-3 py-2 text-sm leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-boxdark dark:bg-boxdark dark:border-boxdark dark:text-gray-400 dark:hover:bg-boxdark dark:hover:text-white">100</a>
                         </li>
                         <li>
                            <a href="#" class="flex items-center justify-center h-full py-1.5 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-boxdark dark:bg-boxdark dark:border-boxdark dark:text-gray-400 dark:hover:bg-boxdark dark:hover:text-white">
